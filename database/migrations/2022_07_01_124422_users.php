...
class Users extends Migration
{
    ...
    public function up()
    {
        ...
        $result = DB::select("SHOW FUNCTION STATUS WHERE name = 'levenshtein'");
        $functionExists = !empty($result);
    ...
    private function countryInsertTemplate(){
        DB::unprepared("
            ...
            ('CC', 'COCOS (ING) ISLANDS', 'Cocos (ing) Islands', NULL, NULL, 672),
            ...
            ('FK', 'FALKLAND ISLANDS (INAS)', 'Falkland Islands (inas)', 'FLK', 238, 500),
            ...
            ('VA', 'HOLY SEE (CAN CITY STATE)', 'Holy See (can City State)', 'VAT', 336, 39),
            ...
            ALTER TABLE `countries` CHANGE `id` `id` CHAR(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, CHANGE `name` `name` VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, CHANGE `nicename` `nicename` VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, CHANGE `iso3` `iso3` CHAR(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;
