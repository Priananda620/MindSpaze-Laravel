...
<body>
    <div style="background-color: #2b2b2b; color: #ffffff; font-family: Arial, sans-serif; line-height: 1.5; margin: 0; padding: 0;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <h2 style="color: #f5bc00; margin-bottom: 20px;">MindSpaze - Reset Your Password</h2>
{{-- {{$avatarUrl}} --}}
            ...
            <div style="background-color: #1d1d1d; padding: 20px; border-radius: 4px;">
                ...
                <p style="margin-bottom: 10px;">
                    <a href="{{ $resetUrl }}" style="text-decoration: none;">
                        <button style="background-color: #f5bc00; color: #ffffff; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer;">
                            Reset Password
                        </button>
                    </a>
                </p>
            ...
            <p style="margin-top: 20px; color: #f5bc00;">Regards, <br> MindSpaze</p>
        </div>
    </div>
</body>
</html>
