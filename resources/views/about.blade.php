...
<main class="nb">
        ...
        <div class="tcontainern">
            <div class="ia rp sw">
                <ul class="iq">
                    ...
                    <li style="">
                        <svg onclick="window.open('https://www.linkedin.com/in/priananda-azhar', '_blank').focus()" style="cursor: pointer" fill="#95a1bc" xmlns="http://www.w3.org/2000/svg" height="50" width="160" viewBox="-40.125525 -16.3118 347.75455 97.8708">
                    ...
                    <li style="">
                        <svg target="_blank" onclick="window.open('https://github.com/Priananda620/MindSpace_SE_Project', '_blank').focus()" style="cursor: pointer" fill="#95a1bc" width="100" height="50" viewBox="0 0 512 139" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                            <g>
    ...
    <section class="nw fillustration-section-l">
        <div class="tcontainern">
            <div class="rp sb">
                <div class="scontainero">
                    ...
                    <p class="lh-sm" style="text-align:justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                        ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                        ullamco laboris nisi ut aliquip ex ea commodo consequat sint occaecat cupidatat non
        ...
        <div class="tcontainern">
            <div class="cta-inner rp sb">
                <div class="scontainero">
                    ...
                    <div class="cta-action reveal-scale-up" data-reveal-delay="200"><a style="width: 15em; margin:auto" class="button" href="https://www.linkedin.com/in/priananda-azhar/" target="_blank" rel="noopener noreferrer">View Threads</a></div>
                </div>
            </div>
        </div>
    </section>
